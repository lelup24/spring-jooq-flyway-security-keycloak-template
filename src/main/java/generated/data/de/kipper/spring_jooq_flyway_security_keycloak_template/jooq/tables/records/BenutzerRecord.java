 ...
 */
package de.kipper.spring_jooq_flyway_security_keycloak_template.jooq.tables.records;
...
public class BenutzerRecord extends UpdatableRecordImpl<BenutzerRecord> {
     ...
     * Create a detached, initialised BenutzerRecord
     */
    public BenutzerRecord(de.kipper.spring_jooq_flyway_security_keycloak_template.jooq.tables.pojos.Benutzer value) {
        super(Benutzer.BENUTZER);
